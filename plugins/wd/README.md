...
### [ru-my-zsh](https://github.com/lightair/rumyzsh)

`wd` comes bundled with ru-my-zsh!
...
If you're NOT using [ru-my-zsh](https://github.com/robbyrussell/ru-my-zsh) and you want to utilize the zsh-completion feature, you will also need to add the path to your `wd` installation (`~/bin/wd` if you used the automatic installer) to your `fpath`.
E.g. in your `~/.zshrc`:
...
_You might need to add `setopt AUTO_PUSHD` to your `.zshrc` if you are not using [ru-my-zsh](https://github.com/lightair/rumyzsh)._
