...
the [jump plugin](https://github.com/lightair/rumyzsh/tree/master/plugins/jump), optionally.
...
- (_Optional_) [`jump`](https://github.com/lightair/rumyzsh/tree/master/plugins/jump) plugin: needs to be
