# diagnostics.zsh
#
# Diagnostic and debugging support for ru-my-zsh
...
# ru-my-zsh, zsh, and the user's system. This is intended to provide a
...
#
# This is intended to be widely portable, and run anywhere that ru-my-zsh does.
...
function _omz_diag_dump_one_big_text() {
  ...
  builtin echo ru-my-zsh diagnostic dump
  builtin echo
  ...
  # Ru-my-zsh installation
  builtin echo ru-my-zsh installation:
  command ls -ld ~/.z*
  command ls -ld ~/.ru*
  builtin echo
  builtin echo ru-my-zsh git state:
  ...
  if [[ -e $ZSH_CUSTOM ]]; then
    ...
    builtin echo "ru-my-zsh custom dir:"
